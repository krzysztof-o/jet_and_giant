package utlis
{
    ...
    public class Pool
    {
         ...
         */
        public function Pool(ObjectClass:Class, strictMode:Boolean = false, initialSize:uint = 0, maxBuffer:uint = 0, initObject:Object = null, resetMethod:String = '', disposeMethod:String = '')
        {

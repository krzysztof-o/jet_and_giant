...
package starling.textures
{
    ...
    public class ConcreteTexture extends Texture
    {
        ...
        private var mHighestMipMapData:BitmapData;
        ...
        private function onContextCreated(event:Event):void
        {
            ...
            if(mHighestMipMapData)
                nativeTexture.uploadFromBitmapData(mHighestMipMapData, 0);
        }

        public function restoreHighestMipMapLevel(bitmapData:BitmapData):void
        {
            mHighestMipMapData = bitmapData;
        }
